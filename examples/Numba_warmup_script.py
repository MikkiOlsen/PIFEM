...
X, T, elem_slab, node_slab = mesh_slab_grid(L_SLAB, W_SLAB, NX_SLAB, NY_SLAB, NUM_X, NUM_Y, JOINT_GAP, JOINT_GAP, nodes_indices=True)
...
truck.build_F(T, X, ref_x_arr[0], TRUCK_REF_Y)
truck.build_F_block(T, X, ref_x_arr[0], TRUCK_REF_Y)
consistent_plate_load(T, X, 1.0)
